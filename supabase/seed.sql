...
begin
  ...
  insert into public.items (deal_id,channel,date,status) values
    (d3,'인스타 피드','2026-06-12','시작 전'),
    (d3,'인스타 스토리','2026-06-12','시작 전'),
    (d10,'쥬디 QNA 오픈채팅방','2026-06-13','시작 전'),
    (d4,'쥬디 QNA 오픈채팅방','2026-06-11','완료'),
    (d4,'오공고 오픈채팅방','2026-06-15','시작 전'),
    (d4,'MMS 광고','2026-06-12','시작 전'),
    (d4,'카카오 채널 DM','2026-06-16','시작 전'),
    (d1,'카카오 채널 DM','2026-06-16','시작 전'),
    (d1,'쥬디 QNA 오픈채팅방','2026-06-16','시작 전'),
    (d2,'인스타 피드','2026-06-15','시작 전'),
    (d2,'웹사이트 상단 배너','2026-06-15','시작 전');
end $$;
